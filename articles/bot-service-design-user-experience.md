...
ms.locfileid: "39297797"
---
# <a name="design-the-user-experience"></a>设计用户体验

机器人通常使用“富用户控件”、“文本和自然语言”和“语音”的某种组合来与用户交换信息。
...
可以通过卡对机器人设计一次，然后就可以让机器人跨各种通道使用。 但是，并非所有卡类型在所有可用通道中都受到完全的支持。 下表显示了当前支持的采样，针对所选通道的多个卡类型。 如需通道支持的最新信息，请确保使用[通道检查器](bot-service-channel-inspector.md)来查看特定卡在你感兴趣的通道中的外观和功能。 如需进一步深入了解自适应卡，请确保也查看<a href="http://adaptivecards.io/visualizer/">自适应卡可视化工具</a>。

下表介绍的通道支持针对多个卡类型，这些卡类型通常会在卡轮播中使用。
...
下表显示的通道支持针对其他类型的 Microsoft 机器人服务卡。

| 通道 | 视频 | 回执 | SignIn | SuggestedAction |
| ---- | ---- | ---- | ---- | ---- |
| Cortana | ✔ | ✔ | ✔ | - |
| O365 电子邮件 | ✔ | ✔ | ✔ | ✔ |
| Facebook | ✔ | ✔ | ✔ | ✔ |
