...
一个对话可以调用对话上下文的 begin dialog 方法并提供新对话的 ID，以便启动同一对话集中的新对话，随后使新对话成为当前的活动对话。 原始对话仍保留在堆栈中，但对对话上下文的 continue dialog 方法的调用只会发送到位于堆栈顶层的对话，即“活动对话”。 将某个对话框从堆栈中弹出后，对话框上下文会在堆栈中弹出原始对话框的位置处继续执行瀑布框的下一步。
