...
ms.locfileid: "39297726"
---
# <a name="handle-user-interrupt"></a>处理用户中断
...
例如，在预订餐位流中，用户说“我想要一个汉堡”。 在此聊天流中，机器人不知道如何处理这种情况。 由于当前流与点餐无关，而机器人的其他聊天命令是“点餐”，因此机器人不知道如何处理此输入。 例如，如果应用 LUIS，则可以训练模型，从而识别用户想要点餐（例如：LUIS 可以返回“orderFood”意向）。 如此，机器人便可提供以下响应：“看来你是想点餐。 要切换到我们的点餐流程吗？” 有关训练 LUIS 和检测用户意向的详细信息，请参阅[针对语言理解的用户 LUIS](bot-builder-howto-v4-luis.md)。
